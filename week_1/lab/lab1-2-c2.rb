puts "1. Use each_with_index, define a to_tasks method so that it's easier to create multiple tasks. Notice that it's easier to come up with 10 tasks now compared to my_tasks in Milestone C1?"
def to_tasks(names)
    @array = []
...
puts "\n\n"
puts "3. Use map.with_index and improve the to_tasks method. HINT: you only need 1 line of code."
...
puts "\n\n"
puts "4. However, we now want to create 10 tasks with random priority between 1-10, not just 1-10" 
